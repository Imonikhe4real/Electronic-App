...
<a href="{{route('admin.bads.index')}}" class="btn btn-default">Back to Main Page</a>
<h3 align="center" style="color:red;">Edit Bad Products Here</h3><br>
<p><span style="color:red;font-weight:bolder">*</span> means required</p>

@include('layouts.flash-message')

<form action="{{ route('admin.bads.update',$data->id) }}" method="POST">  
@csrf
{{ method_field('POST') }}
