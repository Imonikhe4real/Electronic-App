...
<br>
<br>
<div style="font-weight:bolder;font-size:large;color:blue"><center>Users</center> </div>
  @include('layouts.flash-message')
  <div class="table-responsive">
<table class="table table-bordered stripe hover display" id="users">
                    <thead>
                      <tr>
                       <th>Firstname</th>
                       <th>Latname</th>
                     ...
                     <tbody>
                      ...
                      <td>{{ $row->address }}</td>
                    	<td>
                        @can('edit-users')
                    		<a href="{{route('admin.users.edit',$row->id)}}"><button type="button" class="btn btn-warning">
