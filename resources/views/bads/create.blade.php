...
<h3 align="center" style="color:red;">Add Bad Products Here</h3><br>
<p><span style="color:red;font-weight:bolder">*</span> means required</p>

@include('layouts.flash-message')

<form action="{{ route('bads.store') }}" method="POST">  
@csrf
...
<div class="col-md-6">
<select name="electronics"  id="electronics" class="form-control @error('electronics') is-invalid @enderror" style="width:100%;" value="{{ old('electronics') }}" required autofocus>
...
<div class="col-md-6">
<input name="email"  id="email" type="email" class="form-control @error('email') is-invalid @enderror" style="width:100%;" name="email" value="{{ old('email') }}" required autofocus>
