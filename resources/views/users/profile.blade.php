...
<br><br>
<div class="border" style="height:100px;width:50%;">
</div>
<center>
...
<table class="table table-bordered table-striped table-hover" style="width:40%;">
        <tr align="center">
          <td><b>Firstname  </b><td> {{ Auth::user()->firstname }}</td>
        </tr>
        <tr align="center">
          <td><b>Lastname  </b> <td>{{ Auth::user()->lastname }} </td>
        </tr>
        <tr align="center">
          <td><b>Email   </b> <td>{{ Auth::user()->email }} </td>
        </tr>
        <tr align="center">
          <td><b>Mobile  </b> <td>{{ Auth::user()->mobile }} </td>
        </tr>
        <tr align="center">
          <td><b>Gender   </b><td>{{ Auth::user()->gender }} </td>
        </tr>
        <tr align="center">
          <td><b>Address  </b><td>{{ Auth::user()->address }} </td>
        </tr>
</table>
</div>
</center>
